...
int		total_cost(t_pile *node, t_ab *ab)
{
	...
	//Ici utiliser une formule pour que le total ne soit pas egale a la somme des deux couts forcement mais seulement a celui du maximum s'ils vont dans le meme sens
